...
import { GL, attribs, proj, view, uMVP, uColor, uModel, uNormalMat } from './main.js'
...
export function createModelMatrix({ translate = [0, 0, 0], rotate = [], scale = [1, 1, 1] }) {
    ...
    // Apply rotation (array of {axis, angle})
...
export function drawObject(buffers, model, color, mode) {
    // Bind posisi (wajib)
